...
class ManagerCommand:
    def __init__(self):
        self.address_memory_code = str(
            r'services\memory\data\code.pkl'
        )
        self.address_memory_return = str(
            r'services\memory\data\return_code.pkl'
        )
        self.memory = Memory()
        self.out_of_range = {}
        self.codes = []
    ...
    def _assembler_command(self):
        ...
        if self.upload_time:
            ...
            if code:
                ...
                self.out_of_range["upload_time"] = f"Value: {
        ...
        if self.height_threshold:
            ...
            if code:
                ...
                self.out_of_range["height_threshold"] = f"Value: {
        ...
        if self.alarm_battery:
            ...
            if code:
                ...
                self.out_of_range["alarm_battery"] = f"Value: {
        ...
        if self.cycle_detection:
            ...
            if code:
                ...
                self.out_of_range["cycle_detection"] = f"Value: {
        ...
        if self.magnetic_threshold:
            ...
            if code:
                ...
                self.out_of_range["magnetic_threshold"] = f"Value: {
    ...
    def get_adress(self):
        return self.address_memory_code, self.address_memory_return
