        ...
        try:
            ...
            if data_len == len(req_data) / 2:
                if (data_type == "01" or data_type == "02") and (data_len ==38 ):
                    ...
                    data_park_status = True if int(req_data[14:15], 16) == 1 else False
                    data_ultra_status = True if int(req_data[15:16], 16) == 1 else False
                    data_magnet_status = True if int(req_data[16:17], 16) == 1 else False
                    data_battery_status = True if int(req_data[17:18], 16) == 1 else False
                    ...
                    data_timestamp = datetime.fromtimestamp(int(req_data[46:54], 16))
